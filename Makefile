...
.PHONY: env-setup test-unit test-e2e azure-login azure-rg-create azure-rg-exists azure-set-subscription azure-register-provider azure-verify-provider acr-create acr-login acr-login-server acr-credentials sp-create export-acr-json view-acr-json
